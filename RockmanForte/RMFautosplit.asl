...
startup
{
	...
	settings.Add("info0", true, "- Supported emulators : Higan 105/106, Snes9X 1.55 - 1.58, 32 and 64 bit", "infosection");
...
split
{
	...
	if (vars.watchers["stage"].Current == 0 && vars.watchers["sfx"].Old == 57 && vars.watchers["sfx"].Current == 33) {
